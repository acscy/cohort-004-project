...
Only Phase 1 (enrollment notifications, described above in full) is in scope for the current implementation. See `.scratch/in-app-notifications/issues/` for the Phase 1 ticket breakdown.
